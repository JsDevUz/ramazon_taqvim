...
//   const hour_and_minut = todaysIftorTime[TODAY][1].split(":");
//   useEffect(() => {
//     const todays_iftor_targetTime = dayjs()
//       .startOf("day")
//       .add(hour_and_minut[0], "hour")
//       .add(hour_and_minut[1], "minute");
...
//       // Define the target time (4:50 AM)

//       // Define the target time (4:50:00 AM)
//       const todays_iftor_targetTime = dayjs()
//         .startOf("day")
//         .add(hour_and_minut[0], "hour")
//         .add(hour_and_minut[1], "minute");
...
//       // Calculate the difference in seconds
//       let difftodays_inftor_seconds = now.diff(todays_iftor_targetTime, "second");
//       console.log(difftodays_inftor_seconds);

//       // Convert to absolute duration
//       const absDuration = dayjs.duration(Math.abs(difftodays_inftor_seconds), "seconds");

//       // Format the result as HH:mm:ss
//       const result = `${String(absDuration.hours()).padStart(2, "0")}:${String(
//         absDuration.minutes()
...
//     }, 1000);
//   });
//   console.log(todaysIftorTime[TODAY][1]);

//   return (
//     <>
//       <div style={{ fontFamily: "Orbitron" }}>{count}</div>
//     </>
//   );
// }
